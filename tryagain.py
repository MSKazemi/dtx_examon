import sys
sys.path.append("/nas/home/mardebili/scripts/examon/")
import logging
...
plugin_has_cluster_tag = { 
    ...
    'slurm_pub': True,
    'vertiv_pub': False,
    'weather_pub': False, # There is a single metric here with cluster tag; should not be a problem (small data).
...
wanted_tags_per_plugin = {
    ...
    'ipmi_pub': ['*'],   # ToDo: update this with the wanted tags eventually
    'logics_pub': ['*'], # ToDo: update this with the wanted tags eventually
    'nagios_pub': ['*'], # ToDo: update this with the wanted tags eventually
    'vertiv_pub': ['*'], # ToDo: update this with the wanted tags eventually
    'weather_pub': ['*'] # ToDo: update this with the wanted tags eventually
}
...
def TryAgain(metrics):
    ...
    #                               end=  '2021-03-09 00:00:00', 
    #                               freq='24H')

    # complete_date = pd.date_range(start='2021-03-10 00:00:00', 
    #                               end=  '2022-03-09 00:00:00', 
    #                               freq='24H')
    
    # complete_date = pd.date_range(start='2022-03-10 00:00:00', 
    ...
    for _, row in metrics.iterrows():
        ...
        # [Need to Update if use the selected tags !!!]
